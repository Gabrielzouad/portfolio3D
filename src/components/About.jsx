...
<br className="py-12" />
Men det er ikke bare teknologien som driver meg fremover. Jeg er også kjent for å være en effektiv og løsningsorientert person med gode samarbeidsevner. Jeg tar alltid ansvar for mitt arbeid, og sørger for å være strukturert og organisert i alt jeg gjør.<br className="py-12" />
